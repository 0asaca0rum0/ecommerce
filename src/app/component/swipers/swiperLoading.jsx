    ...
    return (
      <div className='flex gap-3 flex-nowrap overflow-auto md:overflow-hidden'>
        {[...Array(nItems)].map((e, i) => (
          ...
          >
            <div className="rounded-lg m-0 h-72 w-52 md:h-80 md:w-60 max-h-none max-w-none  bg-gray-300 px-4 flex justify-center items-center dark:bg-gray-700">
              <svg
              ...
              <div className='flex flex-col absolute bottom-4 gap-4 right-4 z-10'>
                <div class="h-4 bg-gray-400 rounded-full w-16"></div>
                <div class="h-2 bg-gray-400 rounded-full w-10"></div>
              </div >
            </div>
          </div>
        ))}
