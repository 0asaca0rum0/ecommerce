    ...
    return (
        <>
            <div className='w-full  h-full flex flex-col sm:flex-row items-center justify-around gap-3'>
                <Card img={img1} title={"الخطوة الاولى"} subtitle={"سيبسشيبسيشبشبسشيبسيشبيسب"} />
                <Card img={img2} title={"الخطوة الاولى"} subtitle={"سيبسشيبسيشبشبسشيبسيشبيسب"} />
                <Card img={img3} title={"الخطوة الاولى"} subtitle={"سيبسشيبسيشبشبسشيبسيشبيسب"} />
            </div>
